        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><img src="admin/img/gnfi_logo.png" style="width: 30px; height: 30px; padding-left: 5px;" alt=""> <span>GNFI Pegawai</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                ...
                $sql = "SELECT foto FROM pegawai WHERE id_pegawai='$id_pegawai'";
                $s = mysqli_query($conn, $sql) or die (mysqli_error($conn));
                while ($f = mysqli_fetch_assoc($s)) {
              ?>
                <img src="<?php session_start(); echo'admin/img/'.$f['foto']; ?>" alt="..." class="img-circle profile_img"> 
                <?php } ?>           
              </div>
